...
class RegionDiffusionXL(DiffusionPipeline, FromSingleFileMixin):
    ...
    def __init__(
        ...
        #self.vae = AutoencoderKL.from_pretrained(load_path, subfolder="vae", torch_dtype=torch.float32, use_safetensors=True, variant=variant).to(device)
    ...
    def enable_sequential_cpu_offload(self, gpu_id=0):
        ...
        device = torch.device("cpu")  #(f"cuda:{gpu_id}")
